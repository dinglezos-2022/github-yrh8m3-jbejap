  ...
  <article class="is-medium" v-if="showStatic">
    <div class="block">
      ...
      <h2 class="subtitle">
        ...
        <strong>JSON</strong>, information representing the content, not the
        rendered content.
      </h2>
    </div>
    ...
    <section class="message is-primary">
      <div class="message-body">
        We are not building pages, but assembling data into pages. When all we
        have is a JSON strucuture - how do we render that easily?
      </div>
    </section>
